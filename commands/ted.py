...
class Ted(CommandBase):
    ...
    def __init__(self, logger):
        ...
        self.to_register = [
            CommandInfo("ted", self.execute_ted,
                        "Displays information for a specific TED Talk."),
            CommandInfo("tedr", self.execute_tedr,
                        "Displays information for a random TED Talk."),
